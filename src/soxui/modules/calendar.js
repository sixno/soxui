/**
 ...
 @Name:    soxui.calendar | window.soxcalendar
 @Author： sixno
 @License：MIT
...
(function(){
    ...
    function calendar()
    {
        ...
        //字符常量
        ,MOD_NAME = 'calendar', ELEM = '.soxui-calendar', THIS = 'soxui-this', SHOW = 'soxui-show', HIDE = 'soxui-hide', DISABLED = 'calendar-disabled', TIPS_OUT = '开始日期超出了结束日期<br>建议重新选择', LIMIT_YEAR = [100, 200000]
        
        ,ELEM_STATIC = 'soxui-calendar-static', ELEM_LIST = 'soxui-calendar-list', ELEM_SELECTED = 'calendar-selected', ELEM_HINT = 'soxui-calendar-hint', ELEM_PREV = 'calendar-day-prev', ELEM_NEXT = 'calendar-day-next', ELEM_FOOTER = 'soxui-calendar-footer', ELEM_CONFIRM = '.calendar-btns-confirm', ELEM_TIME_TEXT = 'calendar-time-text', ELEM_TIME_BTN = '.calendar-btns-time'
        ...
        */
        ...
        Class.prototype.init = function(){
            ...
            that.elemID = 'soxui-calendar'+ options.elem.attr('lay-key');
        ...
        Class.prototype.render = function(){
            ...
            ,elem = that.elem = lay.elem('div', {
                ...
                ,'class': [
                    'soxui-calendar'
                    ,options.range ? ' soxui-calendar-range' : ''
                    ,isStatic ? (' '+ ELEM_STATIC) : ''
                    ,options.theme && options.theme !== 'default' && !/^#/.test(options.theme) ? (' calendar-theme-' + options.theme) : ''
                ].join('')
            })
            ...
            lay.each(new Array(2), function(i){
                ...
                var divHeader = lay.elem('div', {
                    'class': 'soxui-calendar-header'
                })
                
                //左右切换
                ,headerChild = [function(){ //上一年
                    var elem = lay.elem('i', {
                        'class': 'soxui-icon calendar-icon calendar-prev-y'
                    });
                    elem.innerHTML = '&#xe65a;';
                    return elem;
                }(), function(){ //上一月
                    var elem = lay.elem('i', {
                        'class': 'soxui-icon calendar-icon calendar-prev-m'
                    });
                    elem.innerHTML = '&#xe603;';
                    return elem;
                }(), function(){ //年月选择
                    var elem = lay.elem('div', {
                        'class': 'calendar-set-ym'
                    ...
                    var elem = lay.elem('i', {
                        'class': 'soxui-icon calendar-icon calendar-next-m'
                    });
                    elem.innerHTML = '&#xe602;';
                    return elem;
                }(), function(){ //下一年
                    var elem = lay.elem('i', {
                        'class': 'soxui-icon calendar-icon calendar-next-y'
                    });
                    elem.innerHTML = '&#xe65b;';
                    return elem;
                }()]
                ...
                elemMain[i] = lay.elem('div', {
                    'class': 'soxui-calendar-main calendar-main-list-'+ i
                });
            ...
            lay(divFooter).html(function(){
                ...
                if(options.type === 'datetime'){
                    html.push('<span lay-type="datetime" class="calendar-btns-time">'+ lang.timeTips +'</span>');
                }
                lay.each(options.btns, function(i, item){
                    var title = lang.tools[item] || 'btn';
                    if(options.range && item === 'now') return;
                    if(isStatic && item === 'clear') title = options.lang === 'cn' ? '重置' : 'Reset';
                    btns.push('<span lay-type="'+ item +'" class="calendar-btns-'+ item +'">'+ title +'</span>');
                });
                html.push('<div class="calendar-footer-btns">'+ btns.join('') +'</div>');
                return html.join('');
            }());
            ...
            if(/^#/.test(options.theme)){
                ...
                ,styleText = [
                    '#{{id}} .soxui-calendar-header{background-color:{{theme}};}'
                    ,'#{{id}} .soxui-this{background-color:{{theme}} !important;}'
                ...
                lay(elem).addClass('calendar-theme-molv');
        ...
        Class.prototype.mark = function(td, YMD){
            ...
            mark && td.html('<span class="calendar-day-mark">'+ mark +'</span>');
        ...
        Class.prototype.calendar = function(value){
            ...
            lay.each(tds, function(index, item){
                ...
                if(index < startWeek){
                    ...
                    item.addClass('calendar-day-prev');
                    ...
                    item.addClass('calendar-day-next');
        ...
        Class.prototype.list = function(type, index){
            ...
            if(type === 'year' || type === 'month'){            
                //显示切换箭头
                lay(that.elemMain[index]).addClass('calendar-ym-show');
                ...
                lay(that.elemMain[index]).addClass('calendar-time-show');
        ...
        Class.prototype.closeList = function(){
            ...
            lay.each(that.elemCont, function(index, item){
                ...
                lay(that.elemMain[index]).removeClass('calendar-ym-show calendar-time-show');
            });
        ...
        Class.prototype.change = function(index){
            ...
            ,addSubYeay = function(type){
                ...
                ,isYear = lay(elemCont).find('.calendar-year-list')[0]
                ,isMonth = lay(elemCont).find('.calendar-month-list')[0];
    ...
    {
        soxui.calendar = new calendar();
    }
    else
    {
        window.soxcalendar = new calendar();
    }
})();