/**
 ...
 @Name:    soxui.colorpicker | window.soxcolorpicker
 @Author： sixno
 @License：MIT
...
(function(){
    ...
    function colorpicker()
    {
        ...
        var colorpicker = {
            config: {}
            ,index: soxui.colorpicker ? (soxui.colorpicker.index + 10000) : 0
            ...
            ,on: function(events, callback){
                return soxui.onevent.call(this, 'colorpicker', events, callback);
            }
        }
        ...
        //字符常量
        ,MOD_NAME = 'colorpicker', SHOW = 'soxui-show', THIS = 'soxui-this', ELEM = 'soxui-colorpicker'
        
        ,ELEM_MAIN = '.soxui-colorpicker-main', ICON_PICKER_DOWN = 'soxui-icon-down', ICON_PICKER_CLOSE = 'soxui-icon-close'
        ,PICKER_TRIG_SPAN = 'soxui-colorpicker-trigger-span', PICKER_TRIG_I = 'soxui-colorpicker-trigger-i', PICKER_SIDE = 'soxui-colorpicker-side', PICKER_SIDE_SLIDER = 'soxui-colorpicker-side-slider'
        ,PICKER_BASIS = 'soxui-colorpicker-basis', PICKER_ALPHA_BG = 'soxui-colorpicker-alpha-bgcolor', PICKER_ALPHA_SLIDER = 'soxui-colorpicker-alpha-slider', PICKER_BASIS_CUR = 'soxui-colorpicker-basis-cursor', PICKER_INPUT = 'soxui-colorpicker-main-input'
        ...
        Class.prototype.render = function(){
            ...
            //颜色选择框对象
            ,elemColorBox = $(['<div class="soxui-unselect soxui-colorpicker">'
                ,'<span '+ (options.format == 'rgb' && options.alpha
                        ? 'class="soxui-colorpicker-trigger-bgcolor"'
                    : '') +'>'
                    ,'<span class="soxui-colorpicker-trigger-span" '
                        ...
                        ,'<i class="soxui-icon soxui-colorpicker-trigger-i '+ (options.color 
                            ? ICON_PICKER_DOWN 
                        : ICON_PICKER_CLOSE) +'"></i>'
                    ,'</span>'
                ,'</span>'
            ...
            options.size && elemColorBox.addClass('soxui-colorpicker-'+ options.size); //初始化颜色选择框尺寸
            
            //插入颜色选择框
            othis.addClass('soxui-inline').html(
        ...
        Class.prototype.renderPicker = function(){
            ...
            //颜色选择器对象
            ,elemPicker = that.elemPicker = $(['<div id="soxui-colorpicker'+ that.index +'" data-index="'+ that.index +'" class="soxui-anim soxui-anim-upbit soxui-colorpicker-main">'
                //颜色面板
                ,'<div class="soxui-colorpicker-main-wrapper">'
                    ,'<div class="soxui-colorpicker-basis">'
                        ,'<div class="soxui-colorpicker-basis-white"></div>'
                        ,'<div class="soxui-colorpicker-basis-black"></div>'
                        ,'<div class="soxui-colorpicker-basis-cursor"></div>'
                    ,'</div>'
                    ,'<div class="soxui-colorpicker-side">'
                        ,'<div class="soxui-colorpicker-side-slider"></div>'
                    ,'</div>'
                ,'</div>'
                
                //透明度条块
                ,'<div class="soxui-colorpicker-main-alpha '+ (options.alpha ? SHOW : '') +'">'
                    ,'<div class="soxui-colorpicker-alpha-bgcolor">'
                        ,'<div class="soxui-colorpicker-alpha-slider"></div>'
                    ,'</div>'
                ,'</div>'
                ...
                ,function(){
                    if(options.predefine){
                        var list = ['<div class="soxui-colorpicker-main-pre">'];
                        $.each(options.colors, function(i, v){
                            list.push(['<div class="soxui-colorpicker-pre'+ ((v.match(/[0-9]{1,3}/g) || []).length > 3 
                                ? ' soxui-colorpicker-pre-isalpha' 
                            : '') +'">'
                ...
                //底部表单元素区域
                ,'<div class="soxui-colorpicker-main-input">'
                    ,'<div class="soxui-inline">'
                        ,'<input type="text" class="soxui-input">'
                    ,'</div>'
                    ,'<div class="soxui-btn-container">'
                        ,'<button class="soxui-btn soxui-btn-primary soxui-btn-sm" colorpicker-events="clear">清空</button>'
                        ,'<button class="soxui-btn soxui-btn-sm" colorpicker-events="confirm">确定</button>'
                    ,'</div'
                ,'</div>'
            ,'</div>'].join(''))
        ...
        Class.prototype.removePicker = function(index){
            var that = this
            ,options = that.config;
            $('#soxui-colorpicker'+ (index || that.index)).remove();
            return that;
        };
        ...
        Class.prototype.side = function(){
            ...
            ,pre = that.elemPicker.find('.soxui-colorpicker-pre').children('div')
            ...
            //拖拽元素
            ,elemMove = $(['<div class="soxui-auxiliar-moving" id="LAY-colorpicker-moving"></div'].join(''))
            ...
            pre.each(function(){
                $(this).on('click', function(){
                    $(this).parent('.soxui-colorpicker-pre').addClass('selected').siblings().removeClass('selected');
        ...
        this.render = colorpicker.render;
    ...
    {
        soxui.colorpicker = new colorpicker();
    }
    else
    {
        window.soxcolorpicker = new colorpicker();
    }
})();